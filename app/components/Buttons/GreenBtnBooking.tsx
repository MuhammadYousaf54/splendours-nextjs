...
export function GreenBtnBooking({
  label,
  icon,
  className,
  ...
  return (
    <div className="relative py-8 w-[500px] h-[53px]  flex items-center justify-center ml-8">
      <Modal>
        <ModalTrigger
          className={cn(
            "bg-color text-customColor flex items-center justify-center gap-2 group/modal-btn",
            className
          )}
