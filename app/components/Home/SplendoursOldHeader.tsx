...
export default function SplendoursOldHeader() {
  ...
  return (
    <div>
              {/* Upper Bar */}
              <div className="bg-color h-10 flex justify-center items-center gap-3 px-4 top-0 left-0 w-full z-50">
                <p className="text-sm text-white">
                  REGISTER YOUR INFORMATION FOR FREE STONE SAMPLES SENT EXPRESS TO YOU
                </p>
                <button className="bg-white border border-customColor text-color w-24 h-[30px] rounded-[30px]">
                  Click Here
                </button>
                <button className="border border-customColor text-customColor flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold hover:bg-customColor hover:text-color transition">
              ...
              {/* Main Bar */}
              <div className="bg-secondary h-[45px] flex items-center border border-border justify-between px-4 z-40">
  {/* Increased margin-top to mt-12 */}
  ...
  <div className="flex items-center border-l-2 border-border rounded overflow-hidden">
    ...
    />
              ...
              {/* Lower Bar */}
              <div
                className={`h-[170px] flex items-center justify-between px-4 w-full z-30 transition-all duration-300 ${
