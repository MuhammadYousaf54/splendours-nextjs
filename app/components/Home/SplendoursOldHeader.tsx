    ...
    <header className="fixed top-0 left-0 w-screen z-50">
      ...
      <div className="bg-color h-12 flex justify-center items-center gap-3 px-4 w-full">
        ...
        <Link
          ...
          className="bg-customColor border border-customColor text-color w-[110px] h-[36px] rounded-full text-sm font-medium flex items-center justify-center hover:bg-white"
        >
          Click Here
        </Link>
        <button className="border border-customColor h-[36px] px-5 text-customColor flex items-center justify-center gap-2 rounded-full text-sm font-semibold transition duration-300 hover:text-color hover:bg-customColor">
      ...
      <div
        className={`flex items-center justify-between px-6 w-full h-[120px] transition-all duration-300 ${isScrolled ? "fixed top-[50px] bg-color backdrop-blur-md shadow-lg" : "bg-color relative"}`}
      >
        {/* Left Side Links */}
        <div className="flex space-x-8 p-[10px] relative z-10">
          <div className="flex flex-col items-start space-y-2 relative">
            <Link
              href="/"
              className={`relative inline-block text-sm text-customColor after:content-[''] after:absolute after:left-0 after:top-full after:w-full after:h-[2px] after:bg-customColor after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100 ${
            ...
            <Link
              ...
              className={`relative inline-block text-sm text-customColor after:content-[''] after:absolute after:left-0 after:top-full after:w-full after:h-[2px] after:bg-customColor after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100 ${
                isActive("https://staging.splendourinstone.com.au/reclaimed-bricks/") ? "after:scale-x-100 font-bold" : ""
              }`}
            >
              BRICKS
            </Link>
          ...
          <div className="flex items-center justify-center gap-4 relative">
            <Link
              ...
              className={`relative inline-block text-sm text-customColor after:content-[''] after:absolute after:left-0 after:top-full after:w-full after:h-[2px] after:bg-customColor after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100 ${
                isActive("https://staging.splendourinstone.com.au/walling/") ? "after:scale-x-100 font-bold" : ""
              }`}
            >
              WALLING
            </Link>
            <Link
              ...
              className={`relative inline-block text-sm text-customColor after:content-[''] after:absolute after:left-0 after:top-full after:w-full after:h-[2px] after:bg-customColor after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100 ${
                isActive("https://staging.splendourinstone.com.au/paving/") ? "after:scale-x-100 font-bold" : ""
              }`}
            >
              PAVING
            </Link>
            <Link
              ...
              className={`relative inline-block text-sm text-customColor after:content-[''] after:absolute after:left-0 after:top-full after:w-full after:h-[2px] after:bg-customColor after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100 ${
                isActive("https://staging.splendourinstone.com.au/cobble-stones/") ? "after:scale-x-100 font-bold" : ""
              }`}
            >
              COBBLESTONE
            </Link>
        ...
        {/* Center Logo */}
        <div className="flex justify-center items-center w-full absolute left-1/2 transform -translate-x-1/2 z-0">
          <Image src="/images/main.png" alt="Main Logo" width={290} height={92} />
        </div>

        {/* Right Side Links */}
        <div className="flex space-x-8 text-sm items-center p-[10px] z-10">
          <Link
            href="https://staging.splendourinstone.com.au/about/"
            className={`relative text-sm text-customColor after:content-[''] after:absolute after:left-0 after:top-full after:w-full after:h-[2px] after:bg-customColor after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100 ${
              isActive("https://staging.splendourinstone.com.au/about/") ? "after:scale-x-100 font-bold" : ""
            }`}
          >
            ABOUT
          </Link>
          <div className="flex flex-col items-start space-y-2 relative">
            <Link
              ...
              className={`relative text-sm text-customColor after:content-[''] after:absolute after:left-0 after:top-full after:w-full after:h-[2px] after:bg-customColor after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100 ${
                isActive("https://staging.splendourinstone.com.au/gallery/") ? "after:scale-x-100 font-bold" : ""
              }`}
            >
              GALLERY
            </Link>
            <Link
              ...
              className={`relative text-sm text-customColor after:content-[''] after:absolute after:left-0 after:top-full after:w-full after:h-[2px] after:bg-customColor after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100 ${
                isActive("https://staging.splendourinstone.com.au/contact/") ? "after:scale-x-100 font-bold" : ""
              }`}
            >
              CONTACT
            </Link>
          ...
          <Link
            ...
            className="bg-customColor flex items-center justify-center font-semibold text-color px-4 w-[210px] h-[75px] py-2 rounded-[30px]"
          >
            FREE<br></br>
            MEASURE &
            <br></br>
