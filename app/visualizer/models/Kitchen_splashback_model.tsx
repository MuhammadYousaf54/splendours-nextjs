...
const Kitchen_splashback = ({
  ...
  }, [gltf, selectedBaseColor, selectedArm, selectedNormal, selectedHeight, zoomStatus, rotateStatus, defaultArm, defaultBaseColor, defaultHeight,defaultNormal, textures.baseColor, textures.arm, textures.normal, textures.height]);
...
export default Kitchen_splashback;